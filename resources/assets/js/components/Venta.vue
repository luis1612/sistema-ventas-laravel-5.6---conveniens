                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="venta in arrayVenta" :key="venta.id">
                                        ...
                                        <td v-text="formatPrice(venta.total)"></td>
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td>
                                                {{ formatPrice(detalle.precio*detalle.cantidad-detalle.descuento)}}
                                            </td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
                                            <td colspan="5" align="right"><strong>Total Parcial:</strong></td>
                                            <td>{{formatPrice(totalParcial=(total-totalImpuesto).toFixed(2))}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
                                            <td colspan="5" align="right"><strong>Total Impuesto:</strong></td>
                                            <td>{{formatPrice(totalImpuesto=((total*impuesto)/(1+impuesto)).toFixed(2))}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
                                            <td colspan="5" align="right"><strong>Total Neto:</strong></td>
                                            <td>{{formatPrice(total=calcularTotal)}}</td>
                                        </tr>
                                    </tbody>
                                    <tbody v-else>
                                        <tr>
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="detalle in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td v-text="formatPrice(detalle.precio)">
                                            </td>
                                        ...
                                        <tr style="background-color: #CEECF5;">
                                            ...
                                            <td>{{formatPrice(totalImpuesto=((total*impuesto)).toFixed(2))}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                            ...
                                            <td v-text="formatPrice(articulo.precio_venta)"></td>
